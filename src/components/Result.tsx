  ...
  return (
    <div className="md:flex md:items-center mb-6">
      ...
      <div className="mt-1 relative rounded-md shadow-sm">
        <input
          className="block w-full pl-2 pr-12  bg-green-100 sm:leading-5 md:text-3xl border border-gray-700 focus:border-blue-500 rounded p-1 select-all leading-tight focus:outline-none "
          type="text"
          id="total"
